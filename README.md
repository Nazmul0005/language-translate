...
## Basic Installation
For basic transcription functionality:
```bash
...
4. **Model Conversion**
For converting Hugging Face models to CTranslate2 format:
```bash
...
- For GPU acceleration:
  - CUDA 12
  - cuDNN 9
  - For CUDA 11 and cuDNN 8: use ctranslate2==3.24.0
  - For CUDA 12 and cuDNN 8: use ctranslate2==4.4.0

## Optional Dependencies
- FFmpeg is not required as audio is handled by PyAV
- For real-time translation: internet connection required for translation services
